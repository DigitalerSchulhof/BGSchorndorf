...
$$1.extend($$1.summernote.lang, {
    'de-DE': {
        ...
        image: {
            ...
            resizeFull: 'Volle Breite',
            resizeHalf: 'Halbe Breite',
            resizeQuarter: 'Viertel Breite',
            floatLeft: 'Bild links vom Text',
            floatRight: 'Bild rechts vom Text',
            floatNone: 'Bild als Textzeichen',
        ...
        options: {
            help: 'Hilfe',
            fullscreen: 'Vollbild',
            codeview: 'HTML-Code (Fortgeschrittenen)'
        },
        paragraph: {
            paragraph: 'Textanordnung',
            outdent: 'Einrücken',
            indent: 'Ausrücken',
            left: 'Linksbündig',
            center: 'Zentriert',
        ...
        color: {
            recent: 'Letzte Farben',
            more: 'Mehr Farben',
            background: 'Hintergrundfarbe',
            foreground: 'Schriftfarbe',
            transparent: 'Transparent',
            setTransparent: 'Auf Transparent setzen',
            reset: 'Zurücksetzen',
            resetToDefault: 'Auf schwarz setzen'
        },
        shortcut: {
            shortcuts: 'Tastenkürzel',
            close: 'Fenster schließen',
            textFormatting: 'Text formatieren',
            action: 'Aktion',
            paragraphFormatting: 'Absatz formatieren',
        ...
        specialChar: {
            specialChar: 'Spezielle Zeichen',
            select: 'Spezielle Zeichen auswählen'
        }
    }
});
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div class="form-group note-form-group">',
						...
						'<tr><th>' + this.lang.link.textToDisplay + ':</th><td><input class="note-link-text form-control note-form-control  note-input" type="text" /></td></tr>',
						'<tr><th>' + this.lang.link.url + ':</th><td>',
						'<p><input id="cms_editor_linklink" class="note-link-url form-control note-form-control note-input" type="text" value="http://" /></p>',
						'<p><span class="cms_button" onclick="cms_dateiwahl(\'s\', \'website\', \'-\', \'website\', \'cms_editor_linklink\', \'linkdownload\')">Datei auswählen</span></p>',
						'<p id="cms_editor_linklink_verzeichnis"></p>',
						'</td></tr>',
						'<tr><th>' + this.lang.link.openInNewWindow + ':</th><td><input type="checkbox" id="sn-checkbox-open-in-new-window" checked=""></td></tr>',
						'</table>',
            '</div>'
        ].join('');
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div style=\"display: none;\" class="form-group note-form-group note-group-select-from-files">',
            '<label class="note-form-label">' + this.lang.image.selectFromFiles + '</label>',
            '<input class="note-image-input note-form-control note-input" ',
            ' type="text" name="files" accept="image/*" multiple="multiple" disabled="disabled"/>',
            imageLimitation,
            '</div>',
						'<div class="form-group note-group-image-url" style="overflow:auto;">',
            '<table class="cms_formular">',
						'<tr><th>Bild:</th><td><input id="cms_editor_bilderlink" class="note-image-url form-control note-form-control note-input ',
            ' col-md-12" type="hidden"/><p class="cms_notiz cms_vorschau" id="cms_editor_bilderlink_vorschau">Kein Bild auswgewählt</p><p><span class="cms_button" onclick="cms_dateiwahl(\'s\', \'website\', \'-\', \'website\', \'cms_editor_bilderlink\', \'bilder\')">Bild auswählen</span></p><p id="cms_editor_bilderlink_verzeichnis"></p></td></tr>',
						'</table>',
            '</div>'
        ].join('');
        var buttonClass = 'btn btn-primary note-btn note-btn-primary note-image-btn';
        var footer = "<button id=\"cms_editor_bilderlink_button\" type=\"submit\" href=\"#\" class=\"" + buttonClass + "\" disabled onclick=\"cms_dateiwahl_zuruecksetzen('bilder')\">" + this.lang.image.insert + "</button>";
        this.$dialog = this.ui.dialog({
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
        ...
        var body = [
					'<div class="form-group note-group-image-url" style="overflow:auto;">',
					'<table class="cms_formular">',
					'<tr><th>Video:</th><td><input id="cms_editor_videolink" class="note-video-url form-control note-form-control note-input" type="hidden"/><p id="cms_editor_videolink_vorschau" class="cms_notiz cms_vorschau">Kein Video ausgewählt</p><p><span class="cms_button" onclick="cms_dateiwahl(\'s\', \'website\', \'-\', \'website\', \'cms_editor_videolink\', \'video\')">Video auswählen</span></p><p id="cms_editor_videolink_verzeichnis"></p></td></tr>',
					'</table>',
					'</div>'
        ].join('');
        var buttonClass = 'btn btn-primary note-btn note-btn-primary note-video-btn';
        var footer = "<button id=\"cms_editor_videolink_button\" type=\"submit\" href=\"#\" class=\"" + buttonClass + "\" disabled onclick=\"cms_dateiwahl_zuruecksetzen('video')\">" + this.lang.video.insert + "</button>";
        this.$dialog = this.ui.dialog({
...
var HelpDialog = /** @class */ (function () {
    ...
    HelpDialog.prototype.createShortcutList = function () {
        ...
        return Object.keys(keyMap).map(function (key) {
            ...
            $row.append($$1('<span/>').html(_this.context.memo('help.' + command) || command));
            return $row.html();
        }).join('');
    };
    /**
...
$$1.fn.extend({
    ...
    summernote: function () {
        ...
        // Update options
        options.langInfo = $$1.extend(true, {}, $$1.summernote.lang['de-DE'], $$1.summernote.lang[options.lang]);
