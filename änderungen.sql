...
CREATE TABLE `ebedarf` ( `id` BIGINT(255) UNSIGNED NOT NULL , `bedarf` TINYINT(1) UNSIGNED NULL , `betrag` VARBINARY(1000) NULL , `telefon` VARBINARY(1000) NULL , `emailadresse` VARBINARY(1000) NULL , `eingegangen` BIGINT(255) UNSIGNED NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_unicode_ci;
