...
CREATE TABLE `entwickler_schulhof`.`weiterleiten` ( `id` BIGINT(255) UNSIGNED NOT NULL , `von` VARBINARY(5000) NULL DEFAULT NULL , `zu` VARBINARY(5000) NULL DEFAULT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
