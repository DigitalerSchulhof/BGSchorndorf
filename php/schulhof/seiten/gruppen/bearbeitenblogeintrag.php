...
if (!$fehler) {
  ...
  include_once("php/schulhof/seiten/verwaltung/beschluesse/beschluesse.php");
	...
	$code .= "<div class=\"cms_spalte_i\">";
		...
		$code .= "</p>";
		$code .= "<h1>Blogeintrag bearbeiten für: $gbez </h1>";
		if (isset($_SESSION['BLOGEINTRAGINTERNID'])) {
			$code .= cms_internerblogeintrag_details_laden($_SESSION['BLOGEINTRAGINTERNID'], $g, $gruppenid);
		}
		else {
