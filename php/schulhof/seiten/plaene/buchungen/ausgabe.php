...
function cms_buchungen_ausgeben($buchungsart, $buchungsstandort, $tag, $monat, $jahr, $anonymisiert = false) {
  ...
  // BUCHUNGSMASKE
  if (r("schulhof.organisation.buchungen.$rart.vornehmen")) {
  ...
  if (r("schulhof.organisation.buchungen.$rart.löschen")) {
    ...
    for ($i=0; $i<7; $i++) {
      ...
      foreach ($buchungen[$wochentag] as $b) {
        ...
        $code .= "<div class=\"cms_buchung_$klasse\" style=\"top: $ypos"."px;height: $hoehe"."px;\">";
          ...
          if (($b['person'] == $CMS_BENUTZERID) || r("schulhof.organisation.buchungen.$rart.löschen") {
