...
if ($zugriff) {
	...
	if (isset($_SESSION["FAECHERBEARBEITEN"])) {
		...
		echo "<p><span class=\"cms_button\" onclick=\"cms_schulhof_faecher_bearbeiten();\">Änderungen speichern</span> <a class=\"cms_button_nein\" href=\"Schulhof/Verwaltung/Fächer\">Abbrechen</a></p>";
		}
	else {
