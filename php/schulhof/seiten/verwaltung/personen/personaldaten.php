	...
	if ($zugriff) {
		...
		if ($fehler) {
			...
			$code .= "<table class=\"cms_formular\">";
				...
				$code .= "</tr>";
				$code .= "<tr>";
					$code .= "<th>eine Datei einer abonnierten Gruppe verändert wurde</th>";
					$code .= "<td>".cms_generiere_schieber("schulhof_".$idname."_einstellungen_dateiaenderung", $dateiaenderung)."</td>";
				$code .= "</tr>";
			$code .= "</table>";
