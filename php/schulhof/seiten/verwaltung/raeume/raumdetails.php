...
function cms_raum_ausgeben ($raumid) {
	...
	$code .= "<table class=\"cms_formular\">";
		...
		$code .= "<tr><th>Verfügbar:</th><td>".cms_generiere_schieber('raeume_verfuegbar', $verfuegbar)."</td></tr>";
		$code .= "<tr><th>Buchbar:</th><td>".cms_generiere_schieber('raeume_buchbar', $buchbar)."</td></tr>";
		$code .= "<tr><th>Extern verwaltbar:</th><td>".cms_generiere_schieber('raeume_extern', $extern)."</td></tr>";
