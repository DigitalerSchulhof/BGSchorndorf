...
if (isset($_SESSION['Gruppen']['bearbeiten']['id'])) {
  ...
  cms_trennen($dbs);
  $bearbeiten = $gruppenrechte['bearbeiten'] || r("schulhof.gruppen.$gruppe.bearbeiten");
  $code .= cms_gruppen_verwaltung_gruppeneigenschaften ($gruppe, r("schulhof.gruppen.$gruppe.anlegen") $bearbeiten, $_SESSION['Gruppen']['bearbeiten']['id']);
}
else {
