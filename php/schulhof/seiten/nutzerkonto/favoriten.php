...
if ($sql->execute()) {
	...
	while ($sql->fetch()) {
		...
		$tabellencode .= "<td><span class=\"cms_aktion_klein\" onclick=\"cms_favorit_benennen('$fid')\"><span class=\"cms_hinweis\">Umbenennen</span><img src=\"res/icons/klein/umbennen.png\"></span></td></tr>";
	}
}
$sql->close();
