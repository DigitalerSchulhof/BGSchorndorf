...
if (time() <= $bestellende) {
  ...
  $code .= "<table class=\"cms_formular\">";
    ...
    $code .= "<tr><th>Anrede:</th><td colspan=\"2\"><select id=\"cms_ebestellung_anrede\" name=\"cms_ebestellung_anrede\">";
		...
		$code .= "<tr><th>eMailadresse:</th><td><input name=\"cms_schulhof_ebestellung_mail\" id=\"cms_schulhof_ebestellung_mail\" type=\"text\" onkeyup=\"cms_check_mail_wechsel('ebestellung_mail');\" value=\"$mail\"></td><td><span class=\"cms_eingabe_icon\" id=\"cms_schulhof_ebestellung_mail_icon\"></span></td></tr>";
		...
		$code .= "<tr id=\"cms_ebestellung_bedingung_akzept\"><th>Bedingungen akezptiert:</th><td colspan=\"2\">".cms_schieber_generieren("bedingungen", 0)." Bedingungen gelesen, verstanden und akzeptiert</td></tr>";
	$code  .= "</table>";
	$code .= "</div>";
