...
$zugriff = false;
if ($listenart == 'Lehrer') {           $zugriff = r("schulhof.information.listen.lehrer"); $art = 'l';}
if ($listenart == 'Schüler') {          $zugriff = r("schulhof.information.listen.schüler"); $art = 's';}
if ($listenart == 'Eltern') {           $zugriff = r("schulhof.information.listen.eltern"); $art = 'e';}
if ($listenart == 'Verwaltung') {       $zugriff = r("schulhof.information.listen.verwaltungsangestellte"); $art = 'v';}
if ($listenart == 'Externe') {          $zugriff = r("schulhof.information.listen.externe"); $art = 'x';}
if ($listenart == 'Elternvertreter') {  $zugriff = r("schulhof.information.listen.elternvertreter"); $art = 'ev';}
if ($listenart == 'Schülervertreter') { $zugriff = r("schulhof.information.listen.schülervertreter"); $art = 'sv';}
