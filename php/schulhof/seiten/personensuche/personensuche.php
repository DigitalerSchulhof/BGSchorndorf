      ...
      if (cms_check_idliste($sqlwhere)) {
        ...
        if ($sql->execute()) {
          ...
          while ($sql->fetch()) {
            ...
            $code .= "<td>".$pname."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_upload_'.$pid, $pdateiupload)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_download_'.$pid, $pdateidownload)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_loeschen_'.$pid,  $pdateiloeschen)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_umbenennen_'.$pid,  $pdateiumbenennen)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_termine_'.$pid,  $ptermine)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_blogeintraege_'.$pid,  $pblogeintraege)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_chatten_'.$pid,  $pchatten)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_chat_loeschen_'.$pid,  $pnachrichtloeschen)."</td>";
            $code .= "<td>".cms_generiere_schieber($id.'_personensuche_mitglieder_chat_bannen_'.$pid,  $pnutzerstumm)."</td>";
