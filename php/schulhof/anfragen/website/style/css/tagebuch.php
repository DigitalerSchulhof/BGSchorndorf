...
fwrite($dunkel, ".cms_tagebuch_gesperrt {background: ".$_POST['cms_style_d_haupt_meldungfehlerhinter'].";}\n");

fwrite($dunkel, ".cms_tagebuch_leistungsmessung {color: ".$_POST['cms_style_d_haupt_meldungfehlerakzent'].";}\n");
fwrite($dunkel, ".cms_tagebuch_entschuldigt {color: ".$_POST['cms_style_d_haupt_meldungerfolgakzent'].";}\n");
fwrite($dunkel, ".cms_tagebuch_unentschuldigt {color: ".$_POST['cms_style_d_haupt_meldungfehlerakzent'].";}\n");
fwrite($dunkel, ".cms_tagebuch_positiv {color: ".$_POST['cms_style_d_haupt_meldungerfolgakzent'].";}\n");
fwrite($dunkel, ".cms_tagebuch_negativ {color: ".$_POST['cms_style_d_haupt_meldungfehlerakzent'].";}\n");
fwrite($dunkel, ".cms_tagebuch_neutral {color: ".$_POST['cms_style_d_haupt_meldunginfoakzent'].";}\n");
?>
