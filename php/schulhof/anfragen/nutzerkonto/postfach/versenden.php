			...
			if (cms_check_idliste($sqlempfaenger)) {
				...
				if ($sql->execute()) {
					...
					while ($sql->fetch()) {
						...
						$text = "<p>$anrede</p>";
						$text .= "<p>Im Postfach ist eine neue Nachricht eingegangen.</p>";
						$text .= "<p>Das Postfach ist unter:<br>".$CMS_WICHTIG['Schule Domain']."/Schulhof/Nutzerkonto/Postfach<br> zu erreichen.";
