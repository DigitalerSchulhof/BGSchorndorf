...
if (cms_angemeldet() && cms_r("schulhof.organisation.schulanmeldung.exportieren")) {
	...
	if (!$fehler) {
		...
		if ($sql->execute()) {
			$sql->bind_result($sid, $svor, $sruf, $snach, $sgebd, $sgebo, $sgebl, $smutts, $sverks, $sgeschl, $sreli, $sreliu, $sstaats, $szstaats, $sstrasse, $shausnr, $splz, $sort, $steilort, $stel1, $stel2, $shandy1, $shandy2, $smail, $seinsch, $svorigs, $svorigk, $skuenft, $skzept, $e1nummer, $e1vor, $e1nach, $e1geschl, $e1sorge, $e1briefe, $e1strasse, $e1hausnr, $e1plz, $e1ort, $e1teilort, $e1tel1, $e1tel2, $e1handy, $e1mail, $e2nummer, $e2vor, $e2nach, $e2geschl, $e2sorge, $e2briefe, $e2strasse, $e2hausnr, $e2plz, $e2ort, $e2teilort, $e2tel1, $e2tel2, $e2handy, $e2mail);
			while ($sql->fetch()) {
				$sakzeptiert = $skzept;
				...
				$export .= ';'; // Asylbewerber
				$export .= ';'; // Aussiedler
				$export .= str_replace(';', '‚', $svorigs).';';
				$export .= ';'; // Ausbildungsbetrieb
				$export .= ';'; // Ausbild_beruf_id
				$export .= str_replace(';', '‚', $svorigk).';';
