...
if (isset($_POST['empfehlung'])) {$empfehlung = cms_texttrafo_e_db($_POST['empfehlung']);} else {echo "FEHLER"; exit;}
if (isset($_POST['wunschschueler'])) {$wunschschueler = cms_texttrafo_e_db($_POST['wunschschueler']);} else {echo "FEHLER"; exit;}
...
if (cms_angemeldet() && cms_r("schulhof.organisation.schulanmeldung.bearbeiten")) {
	...
	if (($empfehlung != 'G') && ($empfehlung != 'W') && ($empfehlung != 'R') && ($empfehlung != 'S')) {$fehler = true;}
