...
if (cms_angemeldet() && $zugriff) {
  ...
  if ($downloadanzahl > 0) {
    ...
    for ($i = 0; $i<count($BEGINN); $i++) {
      ...
      $sql->bind_param("ssiiiiiiiiisiii", $bezeichnung, $ort, $BEGINN[$i], $ENDE[$i], $mehrtaegigt, $uhrzeitbt, $uhrzeitet, $ortt, $oeffentlichkeit, $genehmigt, $aktiv, $text, $CMS_BENUTZERID, $jetzt, $terminid);
      $sql->execute();
      $sql->close();
