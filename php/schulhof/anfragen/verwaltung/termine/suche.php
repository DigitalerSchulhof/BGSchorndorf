...
include_once("../../schulhof/seiten/website/termine/terminsuche.php");
...
$loeschen = $CMS_RECHTE['Website']['Termine bearbeiten'];
...
if (cms_angemeldet() && $zugriff) {
  if (!$fehler) {
  	$dbs = cms_verbinden('s');
  	$ausgabe = cms_terminverwaltung_suche($dbs, $jahr, $anzeigen, $bearbeiten, $loeschen);
  	cms_trennen($dbs);
  	echo $ausgabe;
  }
  else {
