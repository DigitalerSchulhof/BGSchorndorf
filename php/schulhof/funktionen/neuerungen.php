...
function cms_neuerungen() {
  ...
  $code .= "</ul>";
  $r .= cms_toggleeinblenden_generieren ('cms_neuerungenverlaufknopf_0_5_4', 'Neuerungen in Version 0.5.4 einblenden', 'Neuerungen in Version 0.5.4 ausblenden', $code, 1);
  ...
  $r .= cms_toggleeinblenden_generieren ('cms_neuerungenverlaufknopf_aeltere', 'Neuerungen älterer Versionen einblenden', 'Neuerungen älterer Version ausblenden', $aeltere, 0);;
  return $r;
}
?>
