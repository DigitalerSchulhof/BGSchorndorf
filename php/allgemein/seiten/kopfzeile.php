		...
		<div id="cms_kopfzeile_i">
			...
			if ($CMS_URL[0] != "App") {
				...
				if ($CMS_ANGEMELDET) {
					...
					echo "<p id=\"cms_app_impressum\">Verantwortlich für die Verarbeitung von Daten in dieser App ist das Land Baden-Württemberg vertreten durch<br>".$CMS_WICHTIG['Schulleitung Name']." • ".$CMS_WICHTIG['Schulname']."<br>".$CMS_WICHTIG['Schule Straße']." • ".$CMS_WICHTIG['Schule PLZOrt']."<br><br>";
