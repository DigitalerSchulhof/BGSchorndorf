...
$code .= cms_postfach_filter_ausgeben('ausgang', $letztenMonatt, $heutet, '-', '', 'app');
...
$code .= "<tbody id=\"cms_postfach_ausgang_liste\">";
  $code .= cms_postfach_nachrichten_listen ('ausgang', '-', 0, $heutet, '', '', '', '', 0, 25, false, 'app');
$code .= "</tbody>";
$code .= "</table>";
