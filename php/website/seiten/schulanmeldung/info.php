...
if ($rueckgabe['zulaessig']) {
  ...
  $code .= "<ul>";
    ...
    if ($CMS_VORANMELDUNG["Persönlich nötig"] == '1') {
      $code .= "<br><b>Anmeldezeitraum Persönlich:</b> ".cms_tagnamekomplett(date('w', $CMS_VORANMELDUNG['Anmeldung persönlich von'])).", den ".date('d.m.Y', $CMS_VORANMELDUNG['Anmeldung persönlich von'])." bis ".cms_tagnamekomplett(date('w', $CMS_VORANMELDUNG['Anmeldung persönlich bis'])).", den ".date('d.m.Y', $CMS_VORANMELDUNG['Anmeldung persönlich bis']);
    }
    $code .= "</li>";
    $code .= "<li>Die Daten werden bis zur vollständigen Anmeldung an der Schule gemäß dem aktuellen Stand der Verschlüsselungstechnik und unter höchsten Sicherheitsvorkehrungen bezüglich der Zugriffskontrolle verschlüsselt auf Servern der ".$CMS_EINSTELLUNGEN['Hosting Schülernetz']." gespeichert, die aus dem Internet zugänglich sind. Die Daten von Schülerinnen und Schülern, die nicht an der Schule aufgenommen werden, werden nach dem Abschluss der Anmeldung gelöscht. Die Daten von aufgenommenen Schülerinnen und Schülern werden nach dem Abschluss der Anmeldung online gelöscht und auf lokale Schulserver übertragen. Vorname, Nachname und Geschlecht von angemeldeten Schülerinnen und Schülern werden in den Digitalen Schulhof übertragen. Sämtliche personenbezogenen Daten werden von allen Speichermedien gelöscht, wenn die Schülerin oder der Schüler die Schule verlässt.</li>";
  ...
  $code .= "<table class=\"cms_formular\">";
    $code .= "<tr><th>Verbindlichkeit:</th><td>".cms_generiere_schieber('voranmeldung_verbindlichkeit', $verbindlichkeit)."</td><td>Mir ist bewusst, dass die online Schulvoranmeldung <b>unverbindlich</b> erfolgt";
    if ($CMS_VORANMELDUNG["Persönlich nötig"] == "1") {
      $code .= " und dass wir zusätzlich an der Schule <b>persönlich vorstellig</b> werden müssen.";
    } else {
      $code .= " bis die schriftlichen Unterlagen der Schule vorliegen.";
    }
    $code .= "</td></tr>";
    $code .= "<tr><th>Gleichbehandlung:</th><td>".cms_generiere_schieber('voranmeldung_gleichbehandlung', $gleichbehandlung)."</td><td>Mir ist bewusst, dass online vorangemeldete Kinder nicht bevorzugt behandelt werden.</td></tr>";
