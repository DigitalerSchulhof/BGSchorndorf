...
if ($id == '-') {$zugriff = r("website.elemente.eventübersicht.anlegen");}
else {$zugriff = r("website.elemente.eventübersicht.bearbeiten");}
...
if (($zugriff) && ($angemeldet)) {
  ...
  if (!$fehler) {
    ...
    if (r("website.freigeben")) {$code .= "<tr><th>Aktiv:</th><td>".cms_schieber_generieren('website_element_eventuebersicht_aktiv', $aktiv)."</td></tr>";}
