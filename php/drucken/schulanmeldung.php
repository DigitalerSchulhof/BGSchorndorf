	...
	if (cms_check_ganzzahl($id, 0) || ($id == 'alle')) {
		...
		foreach ($anmeldeids AS $id) {
			...
			$code .= "<table class=\"cms_liste\">";
				...
				$code .= "<tr><th>Grundschulempfehlung</th><td>".cms_bezeichnung_finden($sempf, 'empfehlungen')."</td></tr>";
				...
				$code .= "<tr><th>WunschmitschülerIn</th><td>$swunsch</td></tr>";
			$code .= "</table>";
			$code .= "</div></div>";
